...
export const registerAdmin = async (data: RegisterAdminDto, createdBy: string): Promise<Omit<User, 'password'>> => {
...
export const login = async (data: LoginDto): Promise<{
...
export const getCurrentUser = async (userId: string): Promise<Omit<User, 'password'> | null> => {
