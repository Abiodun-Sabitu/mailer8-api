...
export class TemplatesService {
  static async createTemplate(data: CreateTemplateDto, createdBy: string): Promise<EmailTemplate> {
  ...
  static async getTemplates(query: GetTemplatesQueryDto): Promise<PaginatedResponse<EmailTemplate>> {
  ...
  static async updateTemplate(id: string, data: UpdateTemplateDto): Promise<EmailTemplate> {
