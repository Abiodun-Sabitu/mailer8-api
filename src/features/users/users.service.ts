...
export class UsersService {
  static async getUsers(query: GetUsersQueryDto): Promise<PaginatedResponse<Omit<User, 'password'>>> {
  ...
  static async updateUserStatus(id: string, data: UpdateUserStatusDto): Promise<Omit<User, 'password'>> {
