...
export const createCustomer = async (data: CreateCustomerDto, createdBy: string): Promise<Customer> => {
...
export const getCustomers = async (query: GetCustomersQueryDto): Promise<PaginatedResponse<Customer>> => {
...
export const getBirthdayCustomers = async (date?: Date): Promise<Customer[]> => {
